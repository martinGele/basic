...
The release job then bundles everything together — the signed app bundle, the SBOM, and the provenance receipt — uploads it to the Play internal track, and tags the release. All automatically, with code shrinking (R8) already switched on.
